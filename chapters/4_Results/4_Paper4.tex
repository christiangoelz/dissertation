...
\caption[Main results of Research Article \uproman{4}]{Main results of Research Article \uproman{4}. UMAP embedding of EEG feature space of fine motor experts and novices. Each color corresponds to one participant; each dot corresponds to one trial. The experts' data clustered structure is more dispersed, and clusters are more compact. 
one trial}
\label{fig:results4}
\end{center}
\end{figure}
