...
The \glspl{eeg} in \hyperref[methods:datasets:I]{Dataset \uproman{1}} and \hyperref[methods:datasets:II]{Dataset \uproman{2}} were recorded with a 32-channel Biosemi active electrode system (ActiveTwo, BioSemi, Amsterdam, Netherlands). In \hyperref[methods:datasets:III]{Dataset \uproman{3}} \gls{eeg} measurements were recorded with a 128-channel actiCap active electrode system (BrainProducts, Munich, Germany).\\
\\
