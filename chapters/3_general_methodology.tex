...
\\
The framework of the Python package scikit-learn was followed to implement the machine learning methods. If the methods were not implemented, they were implemented in Python or Matlab. A detailed description of the complete analysis pipelines and details of the respective implementation can be found in the \hyperref[pub:papers]{published research articles}. 
