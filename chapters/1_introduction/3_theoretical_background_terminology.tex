...
\label{subsec:ML}
Machine learning emerged in the 1950s as a subbranch of artificial intelligence to enable computers to learn without being explicitly programmed \cite{Samual1959}. It is defined by algorithms that automatically extract patterns and trends from data or learn from data \cite{Hastie2009} which then can be used to predict future data, or other kinds of decision making \cite{}


Remembering, adapting, generalizing...\\
With possibility for the automatic analysis of complex multidimensional data machine learning bears great potential for science \cite{Brunton2019}.\\
