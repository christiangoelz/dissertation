...
%%%%%%%%%%%%%%%%%% Formal stuff %%%%%%%%%%%%%%%%%%
    ...
    % Contributions
    \chapter*{List of Publications Considered for Thesis}
    \addcontentsline{toc}{chapter}{List of Publications Considered for Thesis}
